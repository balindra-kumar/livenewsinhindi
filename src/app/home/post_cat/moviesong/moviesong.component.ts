...
@Component({
  standalone: true,
  imports: [CommonModule,HttpClientModule,PostdatePipe,RouterOutlet,RouterLink],
  selector: 'app-moviesong',
  templateUrl: './moviesong.component.html',
  styleUrls: ['./moviesong.component.css']
})
export class MoviesongComponent  implements OnInit{

  //news category post show
  newsReadUrl = "http://balindra.com/post/moviesong.php";
  newsArrayData:any = [];
